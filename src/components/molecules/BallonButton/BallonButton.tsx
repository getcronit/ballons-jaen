 ...
 */
export const BallonButton = forwardRef<BallonButtonProps, "button">((props, ref) => {
  ...
  return (
    <chakra.button
      ...
      _hover={{
        '> svg path': {
          d:
            'path("M22,5C12.4,7.1,4,13.1,4,23s8.4,16.3,18,18c13.4,2.4,73.3,2.5,88,0c9.7-1.6,18-8.1,18-18s-8.2-16.5-18-18 C96,2.8,35.6,2,22,5z")',
          //fill: 'red',
          transition: 'd 0.5s',
        },
        '> .button-text': {
      ...
      _active={{
        '> svg path': {
          d:
            'path("M22,5C11.9,3,4,13.1,4,23s8,19.8,18,18c38.8-7.4,64.1-4.2,88,0c9.7,1.7,18-8.1,18-18s-8.3-19.9-18-18 C87.8,9.3,50.2,10.5,22,5z")',
          //fill: 'red',
          transition: 'd 0.5s',
        },
        '> .button-text': {
